...
import '../need_cares/components/body.dart';
import '../need_cares/components/sign_up.dart';

// ignore: use_key_in_widget_constructors
bool sms = false;

class VerifynPage extends StatefulWidget {
  const VerifynPage({Key? key}) : super(key: key);

  @override
  State<VerifynPage> createState() => _VerifynPageState();
}

class _VerifynPageState extends State<VerifynPage> {
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                onPressed: () => {
                  ...
                  signUp(
                    NeedInputs.needEmailController.text,
